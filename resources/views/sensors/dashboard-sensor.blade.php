...
<nav class="page-breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">All Sensors</li>
	</ol>
</nav>
...
<div class="row">
    ...
    <div class="card">
      <div class="card-body">
        <a href="{{ route('sensors.create') }}" class="btn btn-primary me-2 mb-3">Add New Sensor</a>
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form onsubmit="return confirm('Are You Sure ?');" action="{{ route('sensors.destroy', $sensor->id) }}" method="POST">
